...
<head>
 ...
 <link href="//cdn.shopify.com/s/files/1/0691/5403/t/82/assets/style.scss.css?16677709998824235896" rel="stylesheet"
			...
			<ul class="qp aoa">
			 ...
			 <li class="qg alt">
				...
				<div class="qh">
				 ...
				 <div class="aob">
					Curabitur blandit tempus porttitor. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Duis
	...
	<div class="ha">
	 <ul class="ca qp anw">
		...
		<li class="qg b amk tinted">
		 {!! Form::open(['url' => '#', 'files' => true, 'method'=>'post', 'id' => 'post']) !!}
		 <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
		 {!! Form::textarea('about', null, ['class' => 'form-control expanding', 'rows'=>'4', 'required' => 'required',
		 'placeholder'=>"What's that special meal you ate today?", 'id' => 'about']) !!}
