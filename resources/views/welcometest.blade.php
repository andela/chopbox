                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="pitchcontents" id="web_pitch">
                            <h1 class="tagline man">The Online community for food lovers</h1>
                            <h2 class="convince">Tell your friends about that special meal you just discovered and love so much</h2>
                        </div>
                    </div>
                    ...
                    <div class="content_bottom_v3">
                        <div class="connect_btns_container logged_out_quote_btns">
                            <div class="google_btn_container">
                                <div class="connect">
                                    <a href="#" class="google google_login_click dib pr tal clearfix">
                            ...
                            <div class="fb_btn_container logged_out_quote_btns">
                                <div class="connect">
                                    <a href="#" class="facebook facebook_login_click dib pr tal clearfix">
            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    <form class="form-horizontal" method="post" id="register" role="form">
                        ...
                        <div class="form-group">
                            <button type="submit" name="register" class="form-control btn-info">Sign Up</button>
                        </div>
                    </form>
                </div>
            </div>
