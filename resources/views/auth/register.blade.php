@extends('app') @section('title') Register @stop @section('content')
...
<div class="intro-header">
  <div class="container">
    <div class="col-lg-12">
      ...
      <div class="container">
        <div class="row">
          <h3 class="white-text pull-text-up">Create an account and have
            fun</h3>
            ...
            <div class="panel panel-default">
              ...
              <div class="row">
                <div class="content_bottom_v3 shift-right">
                  <div
                    class="connect_btns_container logged_out_quote_btns push-buttons-down-2"
                    id="buttons">
              ...
              <div class="register-last" id="label">
                <span class="big-text shadow left-space">Already
                  Registered! <a class="white-text"
                  href="{{ url('/login') }}" onClick="">Login Here</a>
                </span>
              </div>
              @if(count($errors) > 0)
              <script type="text/javascript">
