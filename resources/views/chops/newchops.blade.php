...
<div class="container">
  ...
  <div class="form-group">{!! Form::label('name', 'Tell us the name')
    !!} {!! Form::text('name', null, ['class' => 'form-control',
    'required' => 'required']) !!}</div>

  <div class="form-group">{!! Form::label('image', 'Show us an image')
    !!} {!! Form::file('image', ['required' => 'required']) !!}</div>

  <div class="form-group">{!! Form::label('about', 'Tell us about it.')
