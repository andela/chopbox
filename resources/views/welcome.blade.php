        ...
        <div class="row">
          <div class="col-md-6">
            <div class="pitchcontents push-down" id="web_pitch">
              <h1 class="tagline shadow">The Online community for food
                lovers</h1>
              <h2 class="convince shadow">Tell your friends about that
                special meal you just discovered and love so much</h2>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="content_bottom_v3 shift-right">
            ...
            <div class="signup_email_text">
              <a href="#register" id="register"
                class="white-text text-capitalize">Sign up with your
                email!</a>
            </div>
            ...
            <form class="form-horizontal" method="post" id="login"
              ...
              <div class="form-group">
                <button type="submit" name="login"
                  class="btn-primary form-control btn-info">Log In</button>
              </div>
            </form>
            ...
            <form class="form-horizontal" method="post" id="register"
              ...
              <div class="form-group">
                <input type="text" name="name" placeholder="Username..."
                  class="form-control" id="registerName" required=""
                  value="{{old('name')}}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <button type="submit" name="register"
                  class=" btn-primary form-control btn-info">Sign Up</button>
              </div>
